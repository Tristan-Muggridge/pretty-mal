						...
						<div className="card">
							...
							<div className="anime-card-content">
								<div className="play-button">
									<svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 448 512" height="1rem" width="1rem" xmlns="http://www.w3.org/2000/svg">
										<path d="M424.4 214.7L72.4 6.6C43.8-10.3 0 6.1 0 47.9V464c0 37.5 40.7 60.1 72.4 41.3l352-208c31.4-18.5 31.5-64.1 0-82.6z"></path>
									</svg>
								</div>
								<h4 className="title"> Kaguya-sama: Love is War - Ultra Romantic </h4>
								<span className="rating"> 
									<svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 576 512" height="20" width="20" xmlns="http://www.w3.org/2000/svg">
	...
	return (
		<Card>
			<div className='anime-card'>
				...
				<div className='anime-card-content'>
					<a style={{color: "white"}} href={`${anime.id}`} className='play-button'><FaPlay size={"1rem"}/></a>
...
const SeasonalAnime = () => {
	...
	return seasonalAnime.map( (anime: Anime) => <AnimeCard anime={anime} key={'seasonal-'+anime.id} /> )
}

const TopAnime = () => {
	const topAnime = sortBy(useAnime( `http://localhost:8080/anime/top?preview=true` ), 'rank', 'desc');
	return topAnime.map( (anime: Anime) => <AnimeCard anime={anime} key={anime.id} /> )
}